...
public class MainActivity extends FragmentActivity implements View.OnClickListener {
    ...
    protected void onResume() {
        ...
        if (mUhfrManager != null) {
            mUhfrManager.setPower(mSharedPreferences.getInt("readPower", 30),
                    mSharedPreferences.getInt("writePower", 30));// set uhf module power
            ...
            public void run() {
                ...
                while (!destroy) {
                    ...
                    if (mUhfrManager != null) {
                        ...
                        mUhfrManager.setPower(mSharedPreferences.getInt("readPower", 20),
                                mSharedPreferences.getInt("writePower", 20));// t uhf module power
                        mUhfrManager.setRegion(Reader.Region_Conf.valueOf(mSharedPreferences.getInt("freRegion", 1)));
